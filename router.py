...
from app.Rag.RagOperation import  rag_stream_single_invoke
...
async def chat_endpoint(request: Request,body:chatStreamRequest, user = Depends(get_current_user)):
    stream = await rag_stream_single_invoke(body.query, body.userId, body.session_id)
